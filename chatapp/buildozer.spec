...
# (str) Package name
package.name = mychatappapp_beta

# (str) Package domain (needed for android/ios packaging)
package.domain = org.xivver
...
requirements = python3,kivy==2.3.1,kivymd==2.0.0,requests,matrix-nio,asyncgui,asynckivy,materialyoucolor,materialshapes,pillow,pycairo
